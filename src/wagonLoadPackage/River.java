...
public class River extends Location {
	...
	public River(String name, String desc, String prompt, int disTillNext, boolean hasActs, boolean isRiver, String geotype) {
		super(name, desc, prompt, disTillNext, hasActs, isRiver, geotype);
	}
